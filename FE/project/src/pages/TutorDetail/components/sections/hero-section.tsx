...
import { Star, MapPin, Clock, DollarSign, Users, BookOpen, Video, MessageCircle, Calendar } from 'lucide-react';
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <div className="text-center mb-6">
                  <div className="flex items-center justify-center space-x-2 mb-2">
                    ...
                    <span className="text-3xl font-bold text-green-500">${tutor.price}</span>
                    <span className="text-gray-500">/hour</span>
                  </div>
                  <p className="text-sm text-gray-600">Starting from trial lesson</p>
                </div>
